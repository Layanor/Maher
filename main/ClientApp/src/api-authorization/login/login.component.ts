...
export class LoginComponent implements OnInit {
  ...
  private async processLoginCallback(): Promise<void> {
    ...
    switch (result.status) {
      ...
      case AuthenticationResultStatus.Success:
        ...
        // await this.http
        //   .get(this.baseurl + `api/antiforgery`)
        //   .pipe(retry(2))
        //   .subscribe();
  ...
  //   console.log('1', this.xsrftoken);
  //   if (this.xsrftoken === null) {
  //     console.log('2', this.xsrftoken);
  //     this.getxsrf().subscribe(
  //       e => {
  //         console.log('ggggg');
  //         console.log(e);
  //         this.xsrftoken = this.tokenExtractor.getToken() as string;
  //         console.log('3', this.xsrftoken);
  //       },
  //       error => {
  //         console.log('vvvvvv');
  //         console.log('errr', error);
  //         this.xsrftoken = this.tokenExtractor.getToken() as string;
  //         console.log('4', this.xsrftoken);
  //       }
  //     );
  //   }
  //   console.log('5', this.xsrftoken);
  // }
  // private getxsrf(): Observable<any> {
  //   console.log('hhhhhh');
  //   return this.http
  //     .post<any>(this.baseurl + 'WeatherForecast/post/', '')
  //     .pipe(retry(3));
  // }
}
