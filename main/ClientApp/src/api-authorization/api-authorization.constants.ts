export const ApplicationName = 'school';
...
let applicationPaths: ApplicationPathsType = {
  ...
  Register: `authentication/${LoginActions.Login}`,
  ...
  IdentityRegisterPath: '/Identity/Account/Login',
...
applicationPaths = {
  ...
  RegisterPathComponents: applicationPaths.Login.split('/'),
