...
@Component({
  selector: 'app-sgride',
  templateUrl: './sgride.component.html',
  styleUrls: ['./sgride.component.css'],
})
export class SgrideComponent
  implements OnInit, OnDestroy, AfterViewInit, OnChanges
{
  ...
  ngOnInit() {
    ...
    this.data = new DataManager({
      ...
      url: this.ApiUrl, // 'api/Mistritment',
      crossDomain: true,
    });
    this.editSettings = {
      allowEditing: false,
    ...
    if (v === 'EnterDateTime') {
      ...
      templateOption = {
        create: (args: { element: Element; column: Column }) => {
          ...
          console.log(this.data.dataSource.json);
          const data = this.data.dataSource.json;
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    // if (gridn != undefined) {
    //   this.datamanager.dataSource.json = this.data;
    //   this.grid.refresh();
    // }
