import { User, IDTokenClaims, OidcAddress } from 'oidc-client';

export class UserWithAllnot extends User {
override  profile: ProfileWithAll;
}
export type ProfileWithAll = IDTokenClaims & ProfileStandardClaimsWithAll;
interface ProfileStandardClaimsWithAll {
